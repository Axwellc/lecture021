...
public class OrderServiceImpl implements OrderService{
    ...
    public void createOrder(CreateOrderDto createOrderDto) {
        UserDto user = userService.getUser(createOrderDto.getUserId());
...
//          productService.updateStock(createOrderDto.getProductId(), stock);
    ...
    public void deleteOrder(int id) {
        ...
        int sotck = product.getStock() + order.getTotalAmount();
        productService.updateStock(product.getId(), sotck);
